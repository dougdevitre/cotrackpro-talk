...
When you use our SMS program we collect:
...
> **Message frequency may vary. Message and data rates may apply.** Rates are
> charged by your mobile carrier and are not controlled by CoTrackPro.
...
We retain mobile numbers, consent records, and message logs for as long as your
account is active or as needed to provide the service and meet legal,
accounting, or reporting obligations. We use commercially reasonable
administrative, technical, and physical safeguards to protect this information.
...
CoTrackPro Talk is intended for use by adults. The SMS program is not directed to
children and we do not knowingly enroll children's mobile numbers.

## Changes to this policy

We may update this policy from time to time. The "Last updated" date above
reflects the most recent revision. Material changes affecting the SMS program
